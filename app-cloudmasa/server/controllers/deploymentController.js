...
export const saveDeployment = async (req, res) => {
  const {
    selectedTool,
    selectedCluster,
    selectedAccount,
...
export const deployTool = async (req, res) => {
...
export const saveDefault = async (req, res) => {
...
export const installKubectl = (req, res) => {
...
export const deleteDeploymentByTool = async (req, res) => {
...
export const deleteArgoCDApp = async (req, res) => {
  try {
